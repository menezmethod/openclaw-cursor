...
echo ""
echo "To set all cron jobs to cursor/auto (same as heartbeat):"
echo "  node scripts/set-cron-model.js --dry-run   # preview"
echo "  node scripts/set-cron-model.js             # apply"
